...
public class MainActivity extends AppCompatActivity {
        ...
        if (mBTArrayAdapter == null) {
            ...
            /*mRecordBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //intent.putExtra("timer_study", (Parcelable) chronometer_study);
                    startActivity(intent);
                }
            });*/
        }
        ...
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            new Thread()
            {
                public void run() {
                    ...
                    try {
                        mBTSocket[mSocketCount] = createBluetoothSocket(device);
                    } catch (IOException e) {
                        fail = true;
                    ...
                    try {
                        mBTSocket[mSocketCount].connect();
                    } catch (IOException e) {
                        try {
                            fail = true;
                            mBTSocket[mSocketCount].close();
                    ...
                    if(fail == false) {
                        mConnectedThread = new ConnectedThread(mBTSocket[mSocketCount], mSocketCount);
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket, int n) {
            mmSocket = socket;
            idc = n;
